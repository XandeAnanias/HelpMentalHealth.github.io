    ...
    <div class="flex flex-1">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <p class="font-sans text-gray-600 text-start mb-8">Utilize o seu e-mail e senha cadastrados para entrar.</p>

                <!-- Formulário -->
                <form class="space-y-6" action="validaLoginUsuario.php" method="post">
                    <div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Não tem uma conta? <a href="cadastroUsuario.php" class="font-medium text-[#264466] hover:text-[#1a2f45] underline">Crie agora</a><br><br>
